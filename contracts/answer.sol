 ...
 */
contract QuestionAnswerContract is ERC721, ReentrancyGuard {
    ...
    constructor(uint256 _startTime)  ERC721("EphyraAINFT", "Ephyra") ReentrancyGuard() {
     ...
     * @param id 问题ID
     */
    function submit_answer(string calldata answer, uint256 id) external nonReentrant {
    ...
    /**
     * @dev 重写approve函数，禁止授权
     */
    function approve(address to, uint256 tokenId) public override {
        revert("SBT: approve is not allowed");
    }

    /**
     * @dev 重写setApprovalForAll函数，禁止批量授权
     */
    function setApprovalForAll(address operator, bool approved) public override {
        revert("SBT: setApprovalForAll is not allowed");
    }

    /**
     * @dev 重写transferFrom函数，记录转账尝试并拒绝
     */
    ...
    /**
     * @dev 获取用户的SBT tokenId
     */
    function getUserTokenId(address user) external view returns (uint256) {
        require(hasMinted[user], "User has not minted SBT yet");
    ...
    function tokenURI(uint256 /*tokenId*/) public pure override(ERC721) returns (string memory) {
        return "https://eca.ephyra.ai/files/Ephyra.json";
    }
}
